...
INCLUDEPATH += inc/
CFLAGS = -g -I$(INCLUDEPATH) -Wall -pedantic -std=c++14# compilators flags
LIBS =  #libs flags
OUT=Program
...
all: OBJ/vectorNd.o OBJ/matrixNxN.o OBJ/geometric_obj.o OBJ/scene_obj.o OBJ/cuboid.o OBJ/hexagonal_prism.o OBJ/cuboid_obstacle.o OBJ/drone.o OBJ/scene.o  OBJ/scene.o OBJ/lacze_do_gnuplota.o OBJ/main.o 
	@echo "\e[42mKompilacja i konsolidacja programu\e[49m"
	g++ -g -Wall -pedantic -std=c++0x -o ${OUT} OBJ/main.o OBJ/cuboid.o OBJ/scene_obj.o OBJ/vectorNd.o OBJ/matrixNxN.o   OBJ/geometric_obj.o OBJ/hexagonal_prism.o OBJ/drone.o  OBJ/lacze_do_gnuplota.o OBJ/cuboid_obstacle.o OBJ/scene.o
...
OBJ/vectorNd.o: src/vectorNd.cpp inc/vectorNd.hpp
	@echo "\e[44mKompilacja pliku $(bold)vectorNd.cpp$(sgr0)\e[49m"
...
OBJ/matrixNxN.o: src/matrixNxN.cpp inc/matrixNxN.hpp inc/vectorNd.hpp
	@echo "\e[44mKompilacja pliku $(bold)matrixNxN.cpp$(sgr0)\e[49m"
